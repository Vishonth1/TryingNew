...
BOT_TOKEN = environ.get('BOT_TOKEN', '6691829320:AAGjyLfw2qaK2FyutAa5SeKrIKUnjGqfGvY')
#---------------------------------------------------------------
#---------------------------------------------------------------
ADMINS = [int(admin) if id_pattern.search(admin) else admin for admin in environ.get('ADMINS', '5807740619').split()]
USERNAME = environ.get('USERNAME', "https://t.me/untrustedperson") # ADMIN USERNAME
LOG_CHANNEL = int(environ.get('LOG_CHANNEL', '-1002052274277'))
MOVIE_GROUP_LINK = environ.get('MOVIE_GROUP_LINK', 'https://t.me/+-SOhXY1FY9BiNjA0')
CHANNELS = [int(ch) if id_pattern.search(ch) else ch for ch in environ.get('CHANNELS', '-1002132474788 -1002145868115').split()]
#---------------------------------------------------------------
#---------------------------------------------------------------
DATABASE_URI = environ.get('DATABASE_URI', "mongodb+srv://vishnu:vishnu@cluster0.yolrhee.mongodb.net/?retryWrites=true&w=majority&appName=Cluster0")
...
auth_channel = environ.get('AUTH_CHANNEL', '-1001996186113')
